= Getting Started with JBoss EAP XP5 on OpenShift
...
Then install the Helm chart for EAP XP 5 to install the application into OpenShift.
[source,shell]
----
helm install eap-xp5  --repo https://jbossas.github.io/eap-charts/ eap-xp5
----
...
[source,shell]
----
echo https://$(oc get route eap-xp5 --template='{{ .spec.host }}')
----
